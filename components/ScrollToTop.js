...
export default function ScrollToTop({ className }) {
    ...
    return (
        <>
            <a
                href="#home"
                className={`${displayScrollBox} bg-black-500 border border-white-700 text-white-500 text-sm rounded-md px-2 py-2 transition-all flex items-center z-[90] pb-2  ${addClassName}`}
            >
